...
<img src="/assets/img/diagrams/oci-architecture.svg" alt="OCM Service Architecture" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/oci-hydration.svg" alt="Hydration Agent Sequence" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/oci-availability.svg" alt="Availability Domain Distribution" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/oci-tags.svg" alt="Tag Validation Flow" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
