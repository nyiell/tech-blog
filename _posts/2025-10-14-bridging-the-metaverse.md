...
<img src="/assets/img/diagrams/metaverse-trilemma.svg" alt="Interoperability Trilemma" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/metaverse-architecture.svg" alt="Identity-First Architecture" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/metaverse-sequence.svg" alt="Trust Propagation Layer Sequence" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
...
<img src="/assets/img/diagrams/metaverse-polkadot.svg" alt="Polkadot Architecture for Cross-Metaverse Identity" class="no-lightbox" style="width: 95%; display: block; margin: 30px auto;">
